...
var askPath = function () { return __awaiter(void 0, void 0, void 0, function () {
    var path;
...
var askExtension = function () { return __awaiter(void 0, void 0, void 0, function () {
    var extension;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                extension = (_a.sent()).value;
                return [2 /*return*/, extension ? Extension.Typescript : Extension.Javascript];
        }
    });
}); };
exports.createSetup = function () { return __awaiter(void 0, void 0, void 0, function () {
    var path, extension;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                path = _a.sent();
                return [4 /*yield*/, askExtension()];
            case 2:
                extension = _a.sent();
                return [2 /*return*/, { path: path, extension: extension }];
        }
    });
}); };
