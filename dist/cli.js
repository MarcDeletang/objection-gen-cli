...
var relationBuilder_1 = require("./relationBuilder");
var generator_1 = require("./generator");
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, path, extension, models, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, setupBuilder_1.createSetup()];
            case 1:
                _a = _c.sent(), path = _a.path, extension = _a.extension;
                _b = relationBuilder_1.createRelations;
                return [4 /*yield*/, modelBuilder_1.createModels()];
            case 2: return [4 /*yield*/, _b.apply(void 0, [_c.sent()])];
            case 3:
                models = _c.sent();
                return [4 /*yield*/, generator_1.generate(path, extension, models)];
            case 4:
                _c.sent();
                return [2 /*return*/];
        }
