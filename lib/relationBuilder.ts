...
import { relationTypes, Model, Relation, JoinType, RelationType } from './model.js';
...
const createRelationsForOne = async (currentModel: Model, models: Model[]): Promise<Model> => {
...
export const createRelations = async (models: Model[] = []): Promise<Model[]> => {
