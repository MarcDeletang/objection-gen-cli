...
export const abortablePrompts = async<T>(promptOptions: PromptObject): Promise<PromptResponse<T>> => {
...
export const yesOrNoPrompts = async (message: string, initial: YesOrNoInitialValue): Promise<boolean> => {
